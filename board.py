...
class Board(Bitmap):
    ...
    falling = None      #Important - Look at block class
    next = None         #Important -Tuesday lecture at 1:16:00 is useful
    ...
    def __init__(self, width, height, score=0,
        ...
        self.height = height
        self.score = score
        self.cells = set()      #Very Important - Also look at github documentation
        self.cellcolor = {}
        self.lock = Lock()
